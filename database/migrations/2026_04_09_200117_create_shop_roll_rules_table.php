...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('shop_roll_rules')->insert(array_map(static fn (array $rule): array => [
            ...
            ['row_kind' => 'heading', 'rarity' => 'common', 'selection_types' => json_encode(['item'], JSON_THROW_ON_ERROR), 'source_kind' => 'all', 'heading_title' => '## ***:crossed_swords: Common Magic Items (Ab Low Tier):***', 'count' => 0, 'sort_order' => 10],
            ...
            ['row_kind' => 'heading', 'rarity' => 'common', 'selection_types' => json_encode(['item'], JSON_THROW_ON_ERROR), 'source_kind' => 'all', 'heading_title' => '## ***:crossed_swords: Common Consumable:***', 'count' => 0, 'sort_order' => 30],
            ...
            ['row_kind' => 'heading', 'rarity' => 'common', 'selection_types' => json_encode(['item'], JSON_THROW_ON_ERROR), 'source_kind' => 'all', 'heading_title' => '## ***:crossed_swords: Common Spell Scroll:***', 'count' => 0, 'sort_order' => 50],
            ...
            ['row_kind' => 'heading', 'rarity' => 'common', 'selection_types' => json_encode(['item'], JSON_THROW_ON_ERROR), 'source_kind' => 'all', 'heading_title' => '## ***:crossed_swords: Uncommon Magic Items (Ab Low Tier):***', 'count' => 0, 'sort_order' => 70],
            ...
            ['row_kind' => 'heading', 'rarity' => 'common', 'selection_types' => json_encode(['item'], JSON_THROW_ON_ERROR), 'source_kind' => 'all', 'heading_title' => '## ***:crossed_swords: Uncommon Consumable:***', 'count' => 0, 'sort_order' => 90],
            ...
            ['row_kind' => 'heading', 'rarity' => 'common', 'selection_types' => json_encode(['item'], JSON_THROW_ON_ERROR), 'source_kind' => 'all', 'heading_title' => '## ***:crossed_swords: Uncommon Spell Scroll:***', 'count' => 0, 'sort_order' => 110],
            ...
            ['row_kind' => 'heading', 'rarity' => 'common', 'selection_types' => json_encode(['item'], JSON_THROW_ON_ERROR), 'source_kind' => 'all', 'heading_title' => '## ***:crossed_swords: Rare Magic Items (Ab High Tier):***', 'count' => 0, 'sort_order' => 130],
            ...
            ['row_kind' => 'heading', 'rarity' => 'common', 'selection_types' => json_encode(['item'], JSON_THROW_ON_ERROR), 'source_kind' => 'all', 'heading_title' => '## ***:crossed_swords: Rare Consumable/Spell Scroll:***', 'count' => 0, 'sort_order' => 150],
            ...
            ['row_kind' => 'heading', 'rarity' => 'common', 'selection_types' => json_encode(['item'], JSON_THROW_ON_ERROR), 'source_kind' => 'all', 'heading_title' => '## ***:crossed_swords: Very Rare Magic Items (Ab Epic Tier):***', 'count' => 0, 'sort_order' => 170],
            ...
            ['row_kind' => 'heading', 'rarity' => 'common', 'selection_types' => json_encode(['item'], JSON_THROW_ON_ERROR), 'source_kind' => 'all', 'heading_title' => '## ***:crossed_swords: Very Rare Consumable/Spell Scroll:***', 'count' => 0, 'sort_order' => 190],
