...
class UpdateDiscordBotSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'character_retirement_channel_id' => ['nullable', 'string', 'regex:/^[0-9]{5,}$/', 'max:32'],
            'character_retirement_channel_name' => ['nullable', 'string', 'max:255'],
            'character_retirement_channel_guild_id' => ['nullable', 'string', 'regex:/^[0-9]{5,}$/', 'max:32'],
            ...
            'games_scan_months' => ['nullable', 'integer', 'min:1', 'max:24'],
