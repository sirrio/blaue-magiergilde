        ...
        <div className="hero-content relative z-10 flex-col" data-theme={'dark'}>
          <Card className="w-full max-w-2xl prose text-center">
            <CardBody>
              ...
              <p>Website-Betreiber: Diese Webseite wird von {VITE_IMPRESSUM_NAME} als Privatperson betrieben (kein kommerzielles Angebot).</p>
              ...
              <h3 className="font-bold">Urheberrecht</h3>
              <p>
